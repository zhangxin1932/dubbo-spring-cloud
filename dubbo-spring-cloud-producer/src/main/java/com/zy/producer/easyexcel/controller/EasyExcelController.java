package com.zy.producer.easyexcel.controller;

import com.alibaba.excel.EasyExcel;
import com.alibaba.fastjson.JSON;
import com.zy.producer.easyexcel.entity.StuScoreExcel;
import com.zy.producer.easyexcel.listener.StuScoreListener;
import com.zy.producer.easyexcel.mapper.StuScoreMapper;
...
public class EasyExcelController {
    ...
    public String upload(@RequestParam("uploadStuScoreFile") MultipartFile file) throws Exception {
        EasyExcel.read(file.getInputStream(), StuScoreExcel.class, new StuScoreListener(stuScoreMapper)).sheet().doRead();
        return "success";
    }

    private List<StuScoreExcel> data() {
        try {
            List<StuScoreExcel> list = stuScoreMapper.getAllScore();
